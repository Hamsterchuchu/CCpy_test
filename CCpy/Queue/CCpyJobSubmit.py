...
[Suboptions] (optional)
    ...
    -scratch        : use scratch directory when run batch jobs
                      ...
                      ex) CCpyJobSubmit.py 2 I5 -batch -scratch
                      ex) CCpyJobSubmit.py 2 I5 -batch -sub -scratch
    ...
    -dir=[NAME]     : Find vasp jobs under */[NAME]
                      ./graphene/DOS
                      ex) CCpyJobSubmit.py 2 I5 -dir=DOS
